...
const IMPLAUSIBLE_ARTIST_TERMS = /是|最|很|挺|特别|温暖|相遇|拥抱|听|想|要|播放|放|推荐|适合|值得|天气|心情|感觉|类似|相似|像|好听|耐听|顺耳|入耳|对味|舒缓|缓和|轻柔|安静|放松|激昂|热血|澎湃|带感|节奏|国外|外国|欧美|英文|粤语|华语|日语|韩语|法语|德语|西班牙语|俄语|泰语|葡萄牙语|意大利语|今天|明天|昨天|现在|最近|歌单|我们|你们|别的|其他|新歌|老歌|重金属|朋克|古典|纯音乐|随便|再来|继续|接着|还有|还要|另外|关于|有关/
